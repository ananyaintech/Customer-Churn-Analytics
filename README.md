...
This project is based on an open-source churn analysis implementation and has been enhanced with updated documentation, modernized visualizations, reproducible execution workflow, and portfolio-focused presentation.
